                                ...
                                @foreach($permissions as $i => $permission)
                                    <div class="form-check">
                                        <label class="form-check-label" for="{{$permission->name}}" name="permissions[]">
                                            <input type="checkbox" class="form-check-input set_{{$counter}}" id="{{$permission->name}}" name="permissions[]" value="{{$permission->name}}" onchange="unselect_all({{$counter}})">
                                                {{$permission->name}}
                                        </label>
                                    </div>
                                @endforeach
